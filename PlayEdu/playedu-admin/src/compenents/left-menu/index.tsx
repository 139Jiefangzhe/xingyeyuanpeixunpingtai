...
const items = [
  ...
  getItem(
    ...
    [getItem("课程管理", "/courses", null, null, null, null)],
    null,
    null
  ),
  getItem(
    ...
    <i className="iconfont icon-icon-study" />,
    [
      getItem("试卷管理", "/exam/papers", null, null, null, null),
      getItem("题库管理", "/exam/questions", null, null, null, null),
    ],
    null,
    null
  ),
  getItem(
    ...
    "train",
    <i className="iconfont icon-icon-study" />,
    [getItem("培训项目", "/train/projects", null, null, null, null)],
    null,
    null
  ),
  getItem(
    ...
    "live",
    <i className="iconfont icon-icon-study" />,
    [getItem("直播管理", "/live/rooms", null, null, null, null)],
    null,
    null
  ),
  getItem(
...
export const LeftMenu: React.FC = () => {
  ...
  useEffect(() => {
    if (location.pathname.indexOf("/course/user") !== -1) {
      ...
      setSelectedKeys(["/courses"]);
      setOpenKeys(openKeyMerge("/courses"));
    } else if (location.pathname.indexOf("/exam/papers") !== -1) {
      setSelectedKeys(["/exam/papers"]);
      setOpenKeys(openKeyMerge("/exam/papers"));
    } else if (location.pathname.indexOf("/exam/questions") !== -1) {
      setSelectedKeys(["/exam/questions"]);
      setOpenKeys(openKeyMerge("/exam/questions"));
    } else if (location.pathname.indexOf("/train/projects") !== -1) {
      setSelectedKeys(["/train/projects"]);
      setOpenKeys(openKeyMerge("/train/projects"));
